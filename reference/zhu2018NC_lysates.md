...
- `peptides`: quantitative information for 14,921 peptides from 9 lysate
  samples

- `proteins_intensity`: quantitative information for 2,199 proteins from
  9 lysate samples
...
- **Sample preparation** performed in bulk (5E5 cells/mL). Protein
  ...
  alkylation (IAA) + Lys-C digestion + trypsin digestion + cleave
  RapiGest (formic acid).
...
PXD006847). We downloaded the `Vail_Prep_Vail_peptides.txt` and the
`Vail_Prep_Vail_proteinGroups.txt` files containing the combined
...
The same experiment was conducted directly on HeLa cells samples rather
than lysates. The data is available in
[zhu2018NC_hela](https://UCLouvain-CBIO.github.io/scpdata/reference/zhu2018NC_hela.md).
