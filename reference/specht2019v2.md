...
version 2 of the data released in December 2019. It contains
quantitative information of macrophages and monocytes at PSM, peptide
and protein level.
...
Lab](https://scope2.slavovlab.net/mass-spec/data) website via a shared
Google Drive
...
- **Sample preparation** performed using the SCoPE2 protocol. mPOP cell
  lysis + trypsin digestion + TMT-11plex or 16plex labelling and
  pooling.
...
Koller, and Nikolai Slavov. 2019. "Single-Cell Mass-Spectrometry
Quantifies the Emergence of Macrophage Heterogeneity." bioRxiv. ([link
to article](https://doi.org/10.1101/665307)).
