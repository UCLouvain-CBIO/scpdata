...
proteomics (SCP) datasets formatted using the `scp` data structure. 
This structure relies on the 
...
This vignette describes how to access the SCP data sets. To start, we
load the `scpdata` package.
...
`scpdata()`. This will retrieve all the available metadata. For 
