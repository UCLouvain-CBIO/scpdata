...
- New datasets: krull2024, hu2023_K562 and hu2023_oocyte and fixed
  khan2023 imputed data.
...
- dou2019\_\*: Fixed duplicated data, added identification score and
  probabilities data, and generated peptide data.
- zhu2018MCP: added protein data (intensity, LFQ and iBAQ)
- zhu2018NC\_\*: added protein data (intensity, LFQ and iBAQ)
...
- Removed tilde (U+223C) in man pages \<2021-01-09\>

### scpdata 0.99.0

- Bioconductor submission \<2021-01-06\>
